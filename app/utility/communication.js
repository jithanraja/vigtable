...
export const facebook = function (message) {
  if (!message) {
    //console.log('Missing message argument');
    return;
  }
  if (!isCorrectType('String', message)) {
    /*console.log(
      'message was not provided as a string, it was provided as ' +
        Object.prototype.toString.call(message).slice(8, -1),
    );*/
    return;
  }
...
export const twitter = function (message) {
  if (!message) {
    //console.log('Missing message argument');
    return;
  }
